...
/// ForEach that can return the index and the element of the especific array..
///
///  ### Example
///
/// ``` swift
/// // Create a ForEach with the element and the index of the array
/// var body: some View {
///   ForEachWithIndex(array) { index, element in
///     content
///   }
/// }
/// ```
